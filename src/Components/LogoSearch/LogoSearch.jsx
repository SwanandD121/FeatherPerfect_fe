...
const LogoSearch = () => {
  return (
    <div className='logoSearch flex gap-3 items-center overflow-hidden w-full'>
      ...
      <div className="Search flex bg-gray-100 dark:bg-slate-800 rounded-lg p-1 w-full ">
        <input type="text" placeholder='#Explore' className='w-full bg-transparent border-none outline-none dark:text-white pl-2' />
